...
```{r}
is_country(c("United States","Unated States","dot","DNK",123), fuzzy_margin = 0) # 0 is the default
is_country(c("United States","Unated States","dot","DNK",123), fuzzy_margin = 0.1)
```
